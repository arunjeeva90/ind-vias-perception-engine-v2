...
def build_debug_record(state: DMSState, context: dict[str, object], frame: np.ndarray) -> dict[str, Any]:
    ...
    return {
        ...
        "seatbelt_backend": state.cabin_evidence.seatbelt_backend,
        "seatbelt_confidence": state.cabin_evidence.seatbelt_confidence,
        "seatbelt_torso_roi": state.cabin_evidence.seatbelt_torso_roi,
        "seatbelt_candidate_line": state.cabin_evidence.seatbelt_candidate_line,
        "seatbelt_candidate_score": state.cabin_evidence.seatbelt_candidate_score,
        "seatbelt_corridor_score": state.cabin_evidence.seatbelt_corridor_score,
        "seatbelt_width_score": state.cabin_evidence.seatbelt_width_score,
        "seatbelt_edge_pair_score": state.cabin_evidence.seatbelt_edge_pair_score,
        "seatbelt_anchor_score": state.cabin_evidence.seatbelt_anchor_score,
        "seatbelt_temporal_score": state.cabin_evidence.seatbelt_temporal_score,
        "seatbelt_candidate_width_px": state.cabin_evidence.seatbelt_candidate_width_px,
        "seatbelt_expected_width_px": state.cabin_evidence.seatbelt_expected_width_px,
        "seatbelt_track_age_ms": state.cabin_evidence.seatbelt_track_age_ms,
        "seatbelt_track_stable_frames": state.cabin_evidence.seatbelt_track_stable_frames,
        "seatbelt_track_reset_reason": state.cabin_evidence.seatbelt_track_reset_reason,
        "seatbelt_rejected_reason": state.cabin_evidence.seatbelt_rejected_reason,
        "seatbelt_overlay_drawn": state.cabin_evidence.seatbelt_overlay_drawn,
        "seatbelt_confirmed_ms": state.cabin_evidence.seatbelt_confirmed_ms,
        "seatbelt_reason_codes": state.cabin_evidence.seatbelt_reason_codes,
        "seatbelt_affect_final_dms_state": state.cabin_evidence.seatbelt_affect_final_dms_state,
